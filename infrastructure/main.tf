...
resource "aws_lambda_function" "factorio_controller" {
  ...
  function_name    = "factorio-controller"
...
resource "aws_api_gateway_rest_api" "factorio_api" {
  name        = "factorio-api"
  description = "API for Factorio server management"
}
